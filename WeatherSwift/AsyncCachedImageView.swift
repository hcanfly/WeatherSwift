...
final class AsyncCachedImageView: UIImageView {
    ...
    init(frame: CGRect, urlString: String?) {
        ...
        //self.image = AsyncCachedImageView.placeHolderImage
        // start download right away if url is known when view is created
        // but things like tableview cells won't know until later
